...
<?php 
    $sql = "SELECT * FROM archivedContacts ORDER BY ordernumber DESC";
...
?>
    ...
    <div class="grid border">
        ...
        <br>
        <button onclick="archiveMessage('<?php echo $results[$i]['id']; ?>', 'archivedContacts')" class="smallerbuttonsnotpartofnav highlightbackground normaltext center">Unarchive</button>
        <br>
    </div>
